...
# Descargar fixture Switzerland vs Colombia
resp = requests.get(
    "https://v3.football.api-sports.io/fixtures",
    headers=headers,
    params={"league": 1, "season": 2026, "from": "2026-07-07", "to": "2026-07-07"}
)
data = resp.json()
...
for f in data.get("response", []):
    ...
    filas.append({
        ...
        "estado": "AET",  # Tratar como terminado
        "liga": "Mundial 2026",
        "equipo_local": home,
    ...
    print(f"OK: {home} vs {away} {f['goals']['home']}-{f['goals']['away']} PEN")
...
if filas:
    ...
    print(f"CSV actualizado con {len(filas)} partido(s) PEN")
else:
